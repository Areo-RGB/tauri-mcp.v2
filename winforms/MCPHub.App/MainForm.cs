...
public sealed class MainForm : Form
{
    ...
    {
        var header = new Panel { Dock = DockStyle.Top, Height = 58, Padding = new(16, 10, 16, 8), BackColor = Color.FromArgb(238, 240, 243) };
        header.Controls.Add(new Label { Text = "MCPHub", Dock = DockStyle.Left, AutoSize = false, Width = 180, TextAlign = ContentAlignment.MiddleLeft, Font = new Font(Control.DefaultFont.FontFamily, 16, FontStyle.Bold) });
        header.Controls.Add(new Label { Text = "Native C# backend · .NET 10 · win-x64", Dock = DockStyle.Right, AutoSize = false, Width = 310, TextAlign = ContentAlignment.MiddleRight, ForeColor = Color.DimGray });

        var tabs = new TabControl { Dock = DockStyle.Fill, Alignment = TabAlignment.Top, Multiline = false, Padding = new(18, 6), HotTrack = true };
    ...
    private static void AddTab(TabControl tabs, string title, Control content)
    {
        ...
        var page = new TabPage(title) { Padding = new(6) };
